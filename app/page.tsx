...
export default async function Home() {
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto min-h-full">
      ...
      <AdminPanel items={items.map((i: any) => ({ id: i.id, name: i.name, unit: i.unit, packUnit: i.packUnit, packSize: i.packSize, price: i.price, quantity: i.quantity, boxSize: i.boxSize, boxUnit: i.boxUnit }))} />
